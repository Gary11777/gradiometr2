                    ...
                    <div class="bg-white rounded-2xl p-8 border border-gray-200 shadow-xl mb-8">
                        <div class="flex flex-col md:flex-row gap-8 items-start">
                            <div class="w-full md:w-1/3">
                                <img src="{{ asset('images/buy/photo_garand101_8.jpg') }}"
                            ...
                            <div>
                                ...
                                <div class="space-y-2 mb-6 text-sm">
                                    ...
                                    {{-- <div class="flex justify-between border-b border-gray-100 pb-2">
                                        ...
                                        <span class="text-2xl font-bold text-gray-900">$ 2,200 <span
                                                class="text-sm font-normal text-gray-500">USD</span></span>
                                    </div> --}}
                                </div>

                                <p class="text-gray-500 text-md font-bold italic">
                                    Рекомендуем провести тестирование прибора в реальных условиях при личной встрече (г.
                                    Минск).
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="bg-white rounded-2xl p-8 border border-gray-200 shadow-xl">
                        ...
                        <ul class="space-y-6">
                            {{-- <li class="flex items-start group">
                                <div
                                    class="flex-shrink-0 w-10 h-10 bg-brand-50 rounded-full flex items-center justify-center text-brand-600 group-hover:bg-brand-600 group-hover:text-white transition">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-lg text-gray-900 font-medium cursor-pointer"
                                        ...
                                        @click="call()" title="Позвонить">
                                        <span
                                            class="border-b border-dashed border-gray-400 hover:border-brand-500 transition"
                                            x-text="displayPhone"></span>
                                    </p>
                                </div>
                            </li> --}}
                            ...
                            <li class="flex items-start group">
                                ...
                                <div class="ml-4">
                                    ...
                                    <a href="#" x-data="obfuscatedEmail('info', 'gradiometr.com')" @click.prevent="mail()"
                                        x-text="displayEmail"
                    ...
                    <form action="{{ route('contact.submit') }}" method="POST" class="space-y-6"
                        ...
                        <div>
                            ...
                            <input type="text" name="name" id="name" required
                                class="w-full bg-gray-50 border border-gray-300 rounded-lg px-4 py-3 text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent transition"
                                placeholder="Имя Фамилия" value="{{ old('name') }}">
                        ...
                        <div>
                            <label for="phone" class="block text-sm font-medium text-gray-700 mb-2">Телефон
                                (опционально)</label>
                            <input type="tel" name="phone" id="phone"
                                class="w-full bg-gray-50 border border-gray-300 rounded-lg px-4 py-3 text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent transition"
                                placeholder="+375 (XX) XXX-XX-XX" value="{{ old('phone') }}">
                        ...
                        <div>
                            ...
                            <textarea name="message" id="message" rows="4" required
                                class="w-full bg-gray-50 border border-gray-300 rounded-lg px-4 py-3 text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent transition"
                                placeholder="Здравствуйте, хочу купить прибор...">{{ old('message') }}</textarea>
                            @error('message') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                        </div>

                        <!-- Cloudflare Turnstile -->
                        <div class="cf-turnstile"
                            data-sitekey="{{ config('services.turnstile.key', '1x00000000000000000000AA') }}"
